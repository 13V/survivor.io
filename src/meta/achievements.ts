...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  // ---- Expanded arsenal: ten more weapons spread across the ladder ---------
  {
    id: 'whirlwind',
    name: 'Whirlwind',
    desc: 'Kill 1,000 zombies (lifetime).',
    icon: '🌀',
    category: 'milestone',
    stat: 'kills',
    goal: 1000,
    unlock: { kind: 'weapon', id: 'glaive' },
  },
  {
    id: 'live_wire',
    name: 'Live Wire',
    desc: 'Land 2,500 critical hits (lifetime).',
    icon: '⚡',
    category: 'mastery',
    stat: 'crits',
    goal: 2500,
    unlock: { kind: 'weapon', id: 'arc_rifle' },
  },
  {
    id: 'voidtouched',
    name: 'Voidtouched',
    desc: 'Evolve 3 weapons (lifetime).',
    icon: '🔻',
    category: 'discovery',
    stat: 'evolutions',
    goal: 3,
    unlock: { kind: 'weapon', id: 'void_spike' },
  },
  {
    id: 'frostbitten',
    name: 'Frostbitten',
    desc: 'Reach level 12 in a run.',
    icon: '❄️',
    category: 'milestone',
    stat: 'bestLevel',
    goal: 12,
    unlock: { kind: 'weapon', id: 'cryoblast' },
  },
  {
    id: 'shredder',
    name: 'Shredder',
    desc: 'Kill 60 elite pack-leaders.',
    icon: '⚙️',
    category: 'milestone',
    stat: 'eliteKills',
    goal: 60,
    unlock: { kind: 'weapon', id: 'buzzsaw' },
  },
  {
    id: 'star_caller',
    name: 'Star Caller',
    ...
    stat: 'bossKills',
    goal: 3,
    unlock: { kind: 'weapon', id: 'comet' },
  },
  {
    id: 'plaguebearer',
    name: 'Plaguebearer',
    desc: 'Kill 5,000 zombies (lifetime).',
    icon: '🐍',
    category: 'milestone',
    stat: 'kills',
    goal: 5000,
    unlock: { kind: 'weapon', id: 'venom_spitter' },
  },
  {
    id: 'overclocked',
    name: 'Overclocked',
    desc: 'Reach level 15 in a run.',
    icon: '🔮',
    category: 'mastery',
    stat: 'bestLevel',
    goal: 15,
    unlock: { kind: 'weapon', id: 'plasma_orb' },
  },
  {
    id: 'hexweaver',
    name: 'Hexweaver',
    desc: 'Survive 180 seconds in a run.',
    icon: '🔯',
    category: 'milestone',
    stat: 'bestTimeSec',
    goal: 180,
    unlock: { kind: 'weapon', id: 'hex_spiral' },
    coins: 300,
  },
  {
    id: 'lead_storm',
    name: 'Lead Storm',
    desc: 'Kill 20,000 zombies (lifetime).',
    icon: '🔩',
    category: 'milestone',
    stat: 'kills',
    goal: 20000,
    unlock: { kind: 'weapon', id: 'gatling' },
    coins: 500,
  },

  // ---- Scavenged arsenal: ten improvised survival weapons ------------------
  {
    id: 'scrap_mech',
    name: 'Scrap Mechanic',
    desc: 'Kill 750 zombies (lifetime).',
    icon: '🔩',
    category: 'milestone',
    stat: 'kills',
    goal: 750,
    unlock: { kind: 'weapon', id: 'wa_nailgun' },
  },
  {
    id: 'workshop_raid',
    name: 'Workshop Raid',
    desc: 'Kill 40 elite pack-leaders.',
    icon: '⚙️',
    category: 'milestone',
    stat: 'eliteKills',
    goal: 40,
    unlock: { kind: 'weapon', id: 'wb_sawblade' },
  },
  {
    id: 'demolitionist',
    name: 'Demolitionist',
    desc: 'Kill 3,500 zombies (lifetime).',
    icon: '🧨',
    category: 'milestone',
    stat: 'kills',
    goal: 3500,
    unlock: { kind: 'weapon', id: 'wc_pipebomb' },
  },
  {
    id: 'short_circuit',
    name: 'Short Circuit',
    desc: 'Land 1,800 critical hits (lifetime).',
    icon: '⚡',
    category: 'mastery',
    stat: 'crits',
    goal: 1800,
    unlock: { kind: 'weapon', id: 'wd_taser' },
  },
  {
    id: 'firestarter',
    name: 'Firestarter',
    desc: 'Defeat 2 bosses.',
    icon: '🔥',
    category: 'challenge',
    stat: 'bossKills',
    goal: 2,
    unlock: { kind: 'weapon', id: 'we_molotov' },
  },
  {
    id: 'quiet_pro',
    name: 'Quiet Professional',
    desc: 'Reach level 13 in a run.',
    icon: '🏹',
    category: 'milestone',
    stat: 'bestLevel',
    goal: 13,
    unlock: { kind: 'weapon', id: 'wf_crossbow' },
  },
  {
    id: 'chem_war',
    name: 'Chemical Warfare',
    desc: 'Evolve 4 weapons (lifetime).',
    icon: '🧪',
    category: 'discovery',
    stat: 'evolutions',
    goal: 4,
    unlock: { kind: 'weapon', id: 'wg_acidsprayer' },
  },
  {
    id: 'boomstick',
    name: 'Boomstick',
    desc: 'Kill 7,500 zombies (lifetime).',
    icon: '🔫',
    category: 'milestone',
    stat: 'kills',
    goal: 7500,
    unlock: { kind: 'weapon', id: 'wh_autoshotgun' },
  },
  {
    id: 'cold_storage',
    name: 'Cold Storage',
    desc: 'Survive 150 seconds in a run.',
    icon: '❄️',
    category: 'milestone',
    stat: 'bestTimeSec',
    goal: 150,
    unlock: { kind: 'weapon', id: 'wi_cryonade' },
  },
  {
    id: 'magnetar',
    name: 'Magnetar',
    desc: 'Land 4,000 critical hits (lifetime).',
    icon: '📡',
    category: 'mastery',
    stat: 'crits',
    goal: 4000,
    unlock: { kind: 'weapon', id: 'wj_railspike' },
    coins: 300,
  },
  {
    id: 'collector',
